...
./inference/incr_decoding/incr_decoding -ll:gpu 4 -ll:cpu 4 -ll:fsize 14000 -ll:zsize 30000 -ll:util 4 -llm-model baichuan-inc/baichuan-7B -prompt ../inference/prompts/chatgpt.json -tensor-parallelism-degree 4 
